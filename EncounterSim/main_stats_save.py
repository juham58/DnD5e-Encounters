...
save.set_action(action_type="melee", name="Lightning Launcher", dice_rolls=[(1,6,11)], damage_type="lightning")
save.set_action(action_type="melee", name="Lightning Launcher", dice_rolls=[(1,6,11)], damage_type="lightning")
save.save_main_stats()
...
save.set_action(action_type="melee", name="Greatsword, +1", dice_rolls=[(2,6,6), (1,10,0)], damage_type="magical")
save.set_action(action_type="melee", name="Greatsword, +1", dice_rolls=[(2,6,6), (1,10,0)], damage_type="magical")
save.save_main_stats()
...
save.set_action(action_type="melee", name="Claw", dice_rolls=[(1,8,2)], condition="Grappled", auto_success=True, dc_type="str", damage_type="magical")
save.set_action(action_type="melee", name="Claw", dice_rolls=[(1,8,2)], condition="Grappled", auto_success=True, dc_type="str", damage_type="magical")
save.set_action(action_type="melee", name="Sting", dice_rolls=[(1,10,2)], has_dc_effect_on_hit=True, dc_type="con", dc_effect_on_hit=[(4,10,0)], damage_type="poison")
save.save_main_stats()
...
save = MainStats()
save.set_main_stats("Ewyn", ac=20, hp=46, ini_mod=-1, attack_mod=5, number_of_attacks=1, is_monster=False)
save.add_avg_dmg(1, 12, 3)
save.set_abilities(3, -1, 4, 0, 0, 2)
save.set_saves(3, -1, 4, 0, 2, 4)
save.set_action(action_type="melee", name="Greataxe", dice_rolls=[(1,10,3), (2,8,0)])
save.save_main_stats()

save = MainStats()
save.set_main_stats("Gowon", ac=13, hp=33, ini_mod=2, attack_mod=5, number_of_attacks=1, is_monster=False, dc=14)
save.add_avg_dmg(1, 10, 0)
save.set_abilities(0, 2, 3, -1, 1, 4)
save.set_saves(0, 2, 3, -1, 3, 6)
save.set_action(action_type="range", name="Eldritch Blast", dice_rolls=[(1,10,0)], damage_type="force") # Eyldritch Bleeaaaassssttt
save.save_main_stats()
...
save = MainStats()
save.set_main_stats("Vilgefortz", ac=16, hp=27, ini_mod=4, attack_mod=5, number_of_attacks=2, is_monster=False, sneak_attack_dices=2)
save.add_avg_dmg(1, 8, 3)
save.add_avg_dmg(1, 6, 0)
save.set_abilities(-1, 2, 0, 2, 0, 3)
save.set_saves(-1, 6, 0, 4, 0, 3)
...
save.set_action(action_type="melee", name="Slam", dice_rolls=[(2,8,4)])
save.set_action(action_type="melee", name="Slam", dice_rolls=[(2,8,4)])
save.set_action(action_type="melee", name="Consume Energy", dice_rolls=[(4,8,0)], has_attack_mod=False, has_dc=True, dc_type="con", heal=True, heal_type="damage_dealt")
save.save_main_stats()
...
save = MainStats()
save.set_main_stats("Urmelena Mirimm", ac=18, hp=99, attack_mod=12, number_of_attacks=1, ini_mod=5, sneak_attack_dices=8, dc=17)
save.set_abilities(1, 5, 3, 2, 2, 5)
save.set_saves(1, 10, 3, 7, 7, 5)
save.set_action(action_type="melee", name="Silken Spite", dice_rolls=[(1,8,7)], damage_type="magical", has_dc_effect_on_hit=True, condition="poisoned", dc_type="con")
save.save_main_stats()
...
save = MainStats()
save.set_main_stats("Gaspard Maupassant", ac=17, hp=78, ini_mod=7, attack_mod=10, number_of_attacks=2, is_monster=False, sneak_attack_dices=6)
save.set_abilities(0, 5, 1, 0, 1, 2)
save.set_saves(0, 9, 1, 4, 1, 2)
save.set_action(action_type="melee", name="Rapier", dice_rolls=[(1,8,6)])
save.set_action(action_type="melee", name="Hand Crossbow", dice_rolls=[(1,6,5)])
save.save_main_stats()

save = MainStats()
save.set_main_stats("Higher Vampire", ac=19, hp=250, dc=20, ini_mod=8, attack_mod=13, number_of_attacks=4, regeneration=50, legend_actions_charges=3, resistances=["nonmagical", "necrotic"])
...
save = MainStats()
save.set_main_stats("Higher Vampire Blood Rager", ac=19, hp=250, dc=20, ini_mod=8, attack_mod=13, number_of_attacks=4, regeneration=50, legend_actions_charges=3, resistances=["nonmagical", "necrotic", "magical", "fire", "poison", "lightning", "force"], advantage_if_attacked=True)
save.set_abilities(4, 8, 5, 5, 2, 5)
save.set_saves(4, 13, 5, 5, 7, 10)
...
save = MainStats()
save.set_main_stats("Inquisitor of the Sword", ac=16, hp=91, attack_mod=7, number_of_attacks=2, regeneration=10, dc=15, is_monster=False)
save.set_abilities(1, 2, 2, 2, 4, 3)
save.set_saves(1, 2, 2, 5, 7, 6)
save.set_action(action_type="melee", name="Silver Longsword", dice_rolls=[(1,10,4),(4,8,0)])
save.set_action(action_type="melee", name="Silver Longsword", dice_rolls=[(1,10,4),(4,8,0)])
save.save_main_stats()

save = MainStats()
save.set_main_stats("Drow Elite Warrior", ac=18, hp=71, attack_mod=7, number_of_attacks=2, dc=12)
save.set_abilities(1, 4, 2, 0, 1, 1)
save.set_saves(1, 7, 5, 0, 4, 1)
save.set_action(action_type="melee", name="Shortsword", dice_rolls=[(1,6,4),(3,6,0)])
save.set_action(action_type="melee", name="Shortsword", dice_rolls=[(1,6,4),(3,6,0)])
save.save_main_stats()