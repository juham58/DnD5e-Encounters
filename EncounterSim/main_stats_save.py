...
save = MainStats()
save.set_main_stats("Tommy", ac=18, hp=148, dc=14, ini_mod=2, attack_mod=10, number_of_attacks=2, legend_actions_charges=1)
save.set_abilities(5, 2, 4, 2, 0, 0)
save.set_saves(7, 8, 6, 6, 0, 0)
save.set_action(action_type="melee", name="Pike", dice_rolls=[(1,10,6), (1,8,0)])
save.set_action(action_type="melee", name="Pike", dice_rolls=[(1,10,6), (1,8,0)])
...
save = MainStats()
save.set_main_stats("Tony", ac=20, hp=148, dc=14, ini_mod=2, attack_mod=10, number_of_attacks=2, legend_actions_charges=1)
save.set_abilities(5, 2, 4, 2, 0, 0)
save.set_saves(7, 8, 6, 6, 0, 0)
save.set_action(action_type="melee", name="Morningstar", dice_rolls=[(1,10,8), (1,8,0)])
save.set_action(action_type="melee", name="Morningstar", dice_rolls=[(1,10,8), (1,8,0)])
