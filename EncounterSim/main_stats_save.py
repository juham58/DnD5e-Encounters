...
save = MainStats()
save.set_main_stats("Vilgefortz", ac=16, hp=27, ini_mod=4, attack_mod=5, number_of_attacks=2, is_monster=False)
save.add_avg_dmg(1, 8, 3)
save.add_avg_dmg(1, 6, 0)
save.set_abilities(-1, 2, 0, 2, 0, 3)
save.set_saves(-1, 6, 0, 4, 0, 3)
save.set_action(action_type="melee", name="Psychic Blade", dice_rolls=[(1,6,4),(2,6,0)])
save.set_action(action_type="melee", name="Psychic Blade", dice_rolls=[(1,4,4)])
save.save_main_stats()
