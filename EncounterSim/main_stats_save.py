...
save = MainStats()
save.set_main_stats("Gaspard Maupassant", ac=16, hp=78, ini_mod=7, attack_mod=5, number_of_attacks=2, is_monster=False, sneak_attack_dices=6)
save.set_abilities(0, 5, 1, 0, 1, 2)
save.set_saves(0, 9, 1, 4, 1, 2)
save.set_action(action_type="melee", name="Rapier", dice_rolls=[(1,8,5)])
