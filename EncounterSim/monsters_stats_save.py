...
save = MainStats()
save.set_main_stats("Barbed Devil 2014", ac=15, hp=110, attack_mod=6, resistances=["cold", "nonmagical"], immunities=["fire", "poison"])
...
save = MainStats()
save.set_main_stats("Grenat", ac=17, dc=17, hp=150, attack_mod=10, number_of_attacks=3, ini_mod=2, focus_type="focused")
save.set_abilities(5, 2, 2, 4, 1, 1)
save.set_saves(9, 2, 6, 4, 1, 1)
save.set_action(action_type="melee", name="Longsword, +1", dice_rolls="2d8+1d10+8", damage_type="magical")
save.set_action(action_type="melee", name="Longsword, +1", dice_rolls="2d8+8", damage_type="magical")
save.set_action(action_type="melee", name="Longsword, +1", dice_rolls="2d8+8", damage_type="magical")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Vermillon", ac=18, hp=120, attack_mod=11, number_of_attacks=1, ini_mod=5, sneak_attack_dices=8, evasion=True, legend_resistances=2, legend_actions_charges=3)
...
save.set_legend_action(action_type="ranged", name="Ally Attack: Musket", dice_rolls="1d12+5", damage_type="nonmagical")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Cinabre", ac=17, hp=145, ini_mod=5, attack_mod=11, number_of_attacks=2, focus_type="focused")
...
save.set_action(action_type="melee", name="Claws", dice_rolls="1d10+8")
save.set_action(action_type="melee", name="Claws", dice_rolls="1d10+8")
save.set_action(action_type="melee", name="Bite", dice_rolls="5d6+8", damage_type="necrotic")
save.set_legend_action(action_type="melee", charge_cost=1, name="Claws", dice_rolls="1d10+8")
save.set_legend_action(action_type="aoe", charge_cost=1, has_dc=True, dc_type="dex", has_attack_mod=False, is_aoe=True, name="Acid Vial", dice_rolls="4d12", aoe_size=15, damage_type="acid")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Manticore", ac=14, hp=68, attack_mod=5, number_of_attacks=3)
save.set_abilities(3, 3, 3, -2, 1, -1)
save.set_saves(3, 3, 3, -2, 1, -1)
save.set_action(action_type="ranged", name="Tail Spike", dice_rolls="1d8+3")
save.set_action(action_type="ranged", name="Tail Spike", dice_rolls="1d8+3")
save.set_action(action_type="ranged", name="Tail Spike", dice_rolls="1d8+3")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Ettin", ac=12, hp=85, attack_mod=7, number_of_attacks=2)
save.set_abilities(5, -1, 3, -2, 0, -1)
save.set_saves(5, -1, 3, -2, 0, -1)
save.set_action(action_type="melee", name="Battleaxe", dice_rolls="2d8+5")
save.set_action(action_type="melee", name="Morningstar", dice_rolls="2d8+5")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Chimera", ac=14, hp=114, dc=15, ini_mod=0, attack_mod=7, number_of_attacks=3)
save.set_abilities(4, 0, 4, -2, 0, 1)
save.set_saves(4, 3, 7, -2, 3, 4)
save.set_action(action_type="melee", name="Bite", dice_rolls="2d6+4")
save.set_action(action_type="melee", name="Horns", dice_rolls="1d12+4")
save.set_action(action_type="melee", name="Claws", dice_rolls="2d6+4")
save.set_action_in_arsenal(action_type="melee", name="Bite", dice_rolls="2d6+4")
save.set_action_in_arsenal(action_type="melee", name="Horns", dice_rolls="1d12+4")
save.set_action_in_arsenal(action_type="melee", name="Claws", dice_rolls="2d6+4")
...
save = MainStats()
save.set_main_stats("Revenant", ac=13, hp=136, attack_mod=7, number_of_attacks=2, immunities=["Charmed", "Exhaustion", "Frightened", "Paralyzed", "Poisoned", "Stunned"], regeneration=10)
save.set_abilities(4, 2, 4, 1, 3, 4)
save.set_saves(7, 2, 7, 1, 6, 7)
save.set_action(action_type="melee", name="Bite", dice_rolls="2d6+4")
save.set_action(action_type="melee", name="Bite", dice_rolls="2d6+4")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Husk Zombie", ac=10, hp=37, attack_mod=5, number_of_attacks=2, immunities=["Poisoned", "poison"])
save.set_abilities(3, 0, 3, -4, -2, -3)
save.set_saves(3, 0, 5, -4, 0, -3)
save.set_action(action_type="melee", name="Claws", dice_rolls="1d6+3")
save.set_action(action_type="melee", name="Claws", dice_rolls="1d6+3")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Bruxa", ac=18, hp=250, dc=18, ini_mod=8, attack_mod=13, number_of_attacks=3, legend_actions_charges=3, resistances=["nonmagical"])
save.set_abilities(4, 6, 4, 4, 1, 5)
save.set_saves(4, 10, 4, 4, 6, 9)
save.set_action(action_type="melee", name="Claws", dice_rolls="1d10+6", has_advantage=True)
save.set_action(action_type="melee", name="Claws", dice_rolls="1d10+6", has_advantage=True)
...
save = MainStats()
save.set_main_stats("Bes", ac=15, hp=400, dc=18, ini_mod=5, attack_mod=11, number_of_attacks=3, legend_actions_charges=3, resistances=["nonmagical"])
save.set_abilities(4, 6, 4, 4, 1, 5)
save.set_saves(4, 10, 4, 4, 6, 9)
...
save = MainStats()
save.set_main_stats("Worg", ac=13, hp=26, dc=13, ini_mod=1, attack_mod=5, number_of_attacks=2)
save.set_abilities(3, 1, 1, -2, 0, -1)
save.set_saves(3, 1, 1, -2, 0, -1)
save.set_action(action_type="melee", name="Bite", dice_rolls="2d6+3")
save.set_action(action_type="melee", name="Bite", dice_rolls="2d6+3")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Lours", ac=14, hp=42, dc=13, ini_mod=2, attack_mod=7, number_of_attacks=3)
save.set_abilities(5, 2, 3, -3, 1, -2)
save.set_saves(5, 2, 3, -3, 1, -2)
save.set_action(action_type="melee", name="Bite", dice_rolls="1d10+5", has_advantage=True)
...
save = MainStats()
save.set_main_stats("Devil Knight", ac=20, hp=75, attack_mod=10, dc=17, immunities=["fire", "poison"], resistances=["acid", "cold", "nonmagical"], creature_type="fiend")
save.set_abilities(5, 0, 3, 3, 2, 4)
save.set_saves(5, 5, 8, 3, 2, 9)
save.set_action(action_type="melee", name="Hellfire Sword", dice_rolls="1d12+2d10+5", damage_type="fire")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Devil Crossbowman", ac=25, hp=60, attack_mod=10, dc=17, immunities=["fire", "poison"], resistances=["acid", "cold", "nonmagical"], number_of_attacks=2, move_behavior="Ranged", creature_type="fiend")
save.set_abilities(3, 5, 3, 3, 2, 4)
save.set_saves(3, 10, 8, 3, 2, 9)
save.set_action(action_type="ranged", range=120, name="Hellish Crossbow", dice_rolls="2d10+5", damage_type="fire")
save.set_action(action_type="ranged", range=120, name="Hellish Crossbow", dice_rolls="2d10+5", damage_type="fire")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Devil Knight Captain", ac=20, hp=300, number_of_attacks=2, attack_mod=10, dc=17, immunities=["fire", "poison"], resistances=["acid", "cold", "nonmagical"], creature_type="fiend", legend_actions_charges=3, focus_type="focused")
save.set_abilities(5, 0, 3, 3, 2, 4)
save.set_saves(5, 5, 8, 3, 2, 9)
save.set_action(action_type="melee", name="Hellfire Sword", dice_rolls="1d12+2d10+5", damage_type="fire")
save.set_action(action_type="melee", name="Hellfire Sword", dice_rolls="1d12+2d10+5", damage_type="fire")
save.set_legend_action(action_type="melee", charge_cost=1, name="Hellfire Sword", dice_rolls="1d12+2d10+5")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Adult Red Dragon", ac=22, hp=256, dc=21, ini_mod=0, attack_mod=14, number_of_attacks=3, legend_actions_charges=3, legend_resistances=3)
save.set_abilities(8, 0, 7, 3, 1, 6)
save.set_saves(8, 6, 7, 3, 7, 6)
save.set_action(action_type="melee", name="Rend", dice_rolls="1d10+2d4+8")
save.set_action(action_type="melee", name="Rend", dice_rolls="1d10+2d4+8")
save.set_action(action_type="melee", name="Scorching Ray", dice_rolls="1d10+2d4+8")
save.set_action(name="Spellcasting", action_type="spell")
save.set_spell_slots(0, 99, 0, 0, 0, 0, 0, 0, 0)
save.set_spellbook(["Scorching Ray"])
save.set_legend_action(action_type="melee", charge_cost=1, name="Pounce", dice_rolls="1d10+2d4+8")
save.set_action_in_arsenal(action_type="melee", name="Rend", dice_rolls="1d10+2d4+8")
save.set_action_in_arsenal(action_type="spell", name="Spellcasting")
save.set_action_in_arsenal(action_type="aoe", name="Fire Breath", has_attack_mod=False, has_dc=True, dc_type="dex", dice_rolls="17d6", aoe_size=60, aoe_shape="cone", damage_type="fire", has_recharge=True, recharge=5)
save.set_action_in_arsenal(action_type="multiattack", name="Multiattack", multiattack_list=["Rend", "Rend", "Spellcasting"])
save.save_main_stats()

save = MainStats()
save.set_main_stats("Wendigo", ac=16, hp=275, dc=16, ini_mod=-1, attack_mod=9, number_of_attacks=3, legend_actions_charges=3, legend_resistances=3)
save.set_abilities(9, -1, 6, -2, -1, -2)
save.set_saves(9, -1, 6, -2, -1, -2)
save.set_action(action_type="melee", name="Claws", dice_rolls="2d12+5")
save.set_action(action_type="melee", name="Claws", dice_rolls="2d12+5")
save.set_action(action_type="melee", name="Claws", dice_rolls="2d12+5")
save.set_legend_action(action_type="melee", charge_cost=1, name="Claws", dice_rolls="2d12+2d4+5")
save.set_action_in_arsenal(action_type="melee", name="Claws", dice_rolls="2d12+5")
save.set_action_in_arsenal(action_type="aoe", name="Frost Breath", has_attack_mod=False, has_dc=True, dc_type="con", dice_rolls="24d6", aoe_size=60, aoe_shape="cone", damage_type="cold", has_recharge=True, recharge=4)
save.set_action_in_arsenal(action_type="multiattack", name="Multiattack", multiattack_list=["Claws", "Claws", "Claws"])
save.save_main_stats()
# Frost Breath donne 1 niveau Exhaustion (5.5e) sur fail du save

save = MainStats()
save.set_main_stats("Nanuq", ac=16, hp=350, dc=15, ini_mod=2, attack_mod=9, number_of_attacks=3)
save.set_abilities(6, 2, 4, -1, 2, -2)
save.set_saves(6, 2, 7, -1, 5, -2)
save.set_action(action_type="melee", name="Ravage", dice_rolls="6d8+6")
save.set_action(action_type="melee", name="Ravage", dice_rolls="4d8+6", has_advantage=True)
save.set_action(action_type="melee", name="Ravage", dice_rolls="4d8+6", has_advantage=True)
save.save_main_stats()

save = MainStats()
save.set_main_stats("Harpy", ac=11, hp=38, dc=11, ini_mod=1, attack_mod=3, number_of_attacks=1)
save.set_abilities(1, 1, 1, -2, 0, 1)
save.set_saves(1, 1, 1, -2, 0, 1)
save.set_action(action_type="melee", name="Claw", dice_rolls="2d4+1")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Deadly Harpy", ac=11, hp=25, dc=11, ini_mod=4, attack_mod=7, number_of_attacks=2)
save.set_abilities(1, 4, 1, -2, 0, 1)
save.set_saves(1, 4, 1, -2, 0, 1)
save.set_action(action_type="melee", name="Claw", dice_rolls="3d12+4")
save.set_action(action_type="melee", name="Claw", dice_rolls="3d12+4")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Wight", creature_type="undead", ac=14, hp=82, ini_mod=4, attack_mod=4, number_of_attacks=2, resistances=["necrotic"], immunities=["poison"])
save.set_abilities(2, 2, 3, 0, 1, 2)
save.set_saves(2, 2, 3, 0, 1, 2)
save.set_action(action_type="melee", name="Necrotic Sword", dice_rolls="2d8+2")
save.set_action(action_type="melee", name="Necrotic Sword", dice_rolls="2d8+2")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Frost Wight", creature_type="undead", ac=14, hp=82, ini_mod=4, attack_mod=4, number_of_attacks=2, resistances=["cold"], immunities=["poison"])
save.set_abilities(2, 2, 3, 0, 1, 2)
save.set_saves(2, 2, 3, 0, 1, 2)
save.set_action(action_type="melee", name="Frost Sword", dice_rolls="3d8+2")
save.set_action(action_type="melee", name="Frost Sword", dice_rolls="3d8+2")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Frost Wight Archer", creature_type="undead", ac=14, hp=82, ini_mod=4, attack_mod=4, number_of_attacks=2, resistances=["cold"], immunities=["poison"])
save.set_abilities(2, 2, 3, 0, 1, 2)
save.set_saves(2, 2, 3, 0, 1, 2)
save.set_action(action_type="ranged", range=150, name="Frost Bow", dice_rolls="3d8+2")
save.set_action(action_type="ranged", range=150, name="Frost Bow", dice_rolls="3d8+2")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Demilich", ac=20, hp=180, dc=19, ini_mod=17, attack_mod=11, number_of_attacks=3, legend_actions_charges=3, legend_resistances=3)
save.set_abilities(-5, 5, 0, 5, 3, 5)
save.set_saves(-5, 11, 6, 11, 9, 5)
save.set_action(action_type="melee", name="Necrotic Burst", dice_rolls="7d6")
save.set_action(action_type="melee", name="Necrotic Burst", dice_rolls="7d6")
save.set_action(action_type="melee", name="Necrotic Burst", dice_rolls="7d6")
save.set_legend_action(action_type="melee", charge_cost=1, name="Necrotic Burst", dice_rolls="7d6")
save.set_action_in_arsenal(action_type="melee", name="Necrotic Burst", dice_rolls="7d6")
...
save = MainStats()
save.set_main_stats("Crystal Bird", ac=15, hp=300, dc=19, ini_mod=8, attack_mod=13, number_of_attacks=3, legend_actions_charges=3, focus_type="focused")
save.set_abilities(9, 0, 5, -4, 0, -1)
save.set_saves(9, 4, 5, -4, 4, -1)
save.set_action(action_type="melee", name="Beak", dice_rolls="6d12+9", dc_type="con", has_dc_effect_on_hit=True, dc_effect_on_hit="1d12", lingering_damage="1d6")
save.set_action(action_type="melee", name="Beak", dice_rolls="6d12+9", dc_type="con", has_dc_effect_on_hit=True, dc_effect_on_hit="1d12", lingering_damage="1d6")
save.set_action(action_type="aoe", name="Crystal Wings", dice_rolls="6d12+9", dc_type="dex", aoe_shape="cone", aoe_size=30, dc_effect_on_hit="1d12", lingering_damage="1d6")
save.set_legend_action(action_type="melee", charge_cost=1, name="Beak", dice_rolls="6d12+9", dc_type="con", has_dc_effect_on_hit=True, dc_effect_on_hit="1d12", lingering_damage="1d6")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Void Viper", ac=14, hp=60, ini_mod=4, attack_mod=10, number_of_attacks=2, resistances=["cold"], immunities=["poison"])
save.set_abilities(2, 5, 3, 0, 1, 2)
save.set_saves(2, 5, 3, 0, 1, 2)
save.set_action(action_type="melee", name="Void Bite", dice_rolls="8d12+5")
save.set_action(action_type="melee", name="Void Bite", dice_rolls="8d12+5")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Barbed Devil 2024", ac=15, hp=110, attack_mod=6, number_of_attacks=2, resistances=["cold"], immunities=["fire", "poison"])
save.set_abilities(3, 3, 4, 1, 2, 2)
save.set_saves(6, 3, 7, 1, 5, 5)
save.set_action(action_type="melee", name="Claws", dice_rolls="2d6+3")
save.set_action(action_type="melee", name="Tail", dice_rolls="2d10+3")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Adult Blue Dragon", ac=19, hp=350, dc=20, ini_mod=10, attack_mod=12, number_of_attacks=3, legend_actions_charges=4, legend_resistances=4, focus_type="focused")
save.set_abilities(7, 0, 6, 3, 2, 6)
save.set_saves(7, 5, 6, 3, 7, 6)
save.set_action(action_type="melee", name="Rend", dice_rolls="2d8+1d10+7")
save.set_action(action_type="melee", name="Rend", dice_rolls="2d8+1d10+7")
save.set_action(action_type="melee", name="Rend", dice_rolls="2d8+1d10+7")
save.set_legend_action(action_type="melee", charge_cost=1, name="Rend", dice_rolls="2d8+1d10+7")
save.set_action_in_arsenal(action_type="melee", name="Rend", dice_rolls="2d8+1d10+7")
...
save = MainStats()
save.set_main_stats("Colonel Duval", ac=13, hp=350, ini_mod=5, attack_mod=8, number_of_attacks=4, resistances=["acid", "necrotic", "nonmagical", "cold", "fire", "lightning", "thunder"], creature_type="undead", legend_actions_charges=3, legend_resistances=3, focus_type="focused")
save.set_abilities(-1, 5, 0, 0, 1, 3)
save.set_saves(-1, 5, 0, 0, 1, 3)
save.set_action(action_type="melee", name="Glacial Blade", dice_rolls="8d6+3")
save.set_action(action_type="melee", name="Glacial Blade", dice_rolls="8d6+3")
save.set_action(action_type="melee", name="Glacial Blade", dice_rolls="8d6+3")
save.set_action(action_type="melee", name="Glacial Blade", dice_rolls="8d6+3")
save.set_legend_action(action_type="melee", name="Glacial Blade", dice_rolls="8d6+3", charge_cost=1)
save.save_main_stats()

save.set_main_stats("Zoldane Grotesque", ac=19, hp=350, dc=20, ini_mod=8, attack_mod=11, number_of_attacks=4, regeneration=20, legend_resistances=3, legend_actions_charges=3, resistances=["nonmagical", "necrotic", "fire", "poison", "lightning"], focus_type="focused")
save.set_abilities(4, 8, 5, 5, 2, 5)
save.set_saves(4, 13, 5, 5, 7, 10)
save.set_action(action_type="melee", name="Claws", dice_rolls="1d10+8")
save.set_action(action_type="melee", name="Claws", dice_rolls="1d10+8")
...
save = MainStats()
save.set_main_stats("Éthère", ac=18, hp=400, dc=17, ini_mod=4, attack_mod=12, number_of_attacks=4, legend_actions_charges=3, creature_type="undead", resistances=["necrotic", "nonmagical"], legend_resistances=3, regeneration=20, is_mythic=True, mythic_hp=200, focus_type="focused")
save.set_abilities(4, 4, 4, 3, 2, 4)
save.set_saves(4, 9, 4, 3, 7, 9)
# bonus action Vampire Charm (Monster Manual 2014)
save.set_action(action_type="melee", name="Claws", dice_rolls="4d8+4", damage_type="magical")
save.set_action(action_type="melee", name="Claws", dice_rolls="4d8+4", damage_type="magical")
save.set_action(action_type="melee", name="Claws", dice_rolls="4d8+4", damage_type="magical")
save.set_action(action_type="melee", name="Bite", dice_rolls="1d4+8d8+4", damage_type="necrotic", is_heal=True, heal_type="damage_dealt")
save.set_legend_action(action_type="melee", charge_cost=1, name="Claws", dice_rolls="2d8+2d6+4", damage_type="magical")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Vampire Spawn (Éthère)", ac=15, hp=50, dc=13, ini_mod=8, attack_mod=6, creature_type="undead", number_of_attacks=2, resistances=["nonmagical", "necrotic"])
save.set_abilities(3, 3, 3, 0, 0, 1)
save.set_saves(3, 6, 3, 0, 3, 1)
save.set_action(action_type="melee", name="Claws", dice_rolls="2d4+3")
save.set_action(action_type="melee", name="Bite", dice_rolls="1d6+2d6+3")
