...
save = MainStats()
save.set_main_stats("Devil Knight", ac=20, hp=90, attack_mod=10, dc=17, immunities=["fire", "poison"], resistances=["acid", "cold", "nonmagical"], creature_type="fiend")
save.set_abilities(5, 0, 3, 3, 2, 4)
save.set_saves(5, 5, 8, 3, 2, 9)
save.set_action(action_type="melee", name="Hellfire Sword", dice_rolls="1d12+3d10+5", damage_type="fire")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Devil Crossbowman", ac=20, hp=90, attack_mod=10, dc=17, immunities=["fire", "poison"], resistances=["acid", "cold", "nonmagical"], number_of_attacks=2, move_behavior="Ranged", creature_type="fiend")
save.set_abilities(3, 10, 3, 3, 2, 4)
...
save = MainStats()
save.set_main_stats("Devil Crossbowman_2", ac=20, hp=90, attack_mod=10, dc=17, immunities=["fire", "poison"], resistances=["acid", "cold", "nonmagical"], number_of_attacks=2, move_behavior="Ranged", creature_type="fiend")
save.set_abilities(3, 10, 3, 3, 2, 4)
save.set_saves(3, 10, 8, 3, 2, 9)
save.set_action(action_type="ranged", range=120, name="Hellish Crossbow", dice_rolls="2d10+5", damage_type="fire")
save.set_action(action_type="ranged", range=120, name="Hellish Crossbow", dice_rolls="2d10+5", damage_type="fire")
...
save = MainStats()
save.set_main_stats("Devil Crossbowman_3", ac=20, hp=90, attack_mod=10, dc=17, immunities=["fire", "poison"], resistances=["acid", "cold", "nonmagical"], number_of_attacks=2, move_behavior="Ranged", creature_type="fiend")
save.set_abilities(3, 10, 3, 3, 2, 4)
save.set_saves(3, 10, 8, 3, 2, 9)
save.set_action(action_type="ranged", range=120, name="Hellish Crossbow", dice_rolls="2d10+5", damage_type="fire")
save.set_action(action_type="ranged", range=120, name="Hellish Crossbow", dice_rolls="2d10+5", damage_type="fire")
