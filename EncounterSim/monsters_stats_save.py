...
save = MainStats()
save.set_main_stats("Ancient White Dragon", ac=20, hp=350, dc=22, ini_mod=0, attack_mod=14, number_of_attacks=3, legend_actions_charges=3, legend_resistances=3)
save.set_abilities(8, 0, 8, 0, 1, 2)
save.set_saves(8, 6, 14, 0, 7, 8)
...
save.set_action(action_type="melee", name="Claws", dice_rolls="2d6+8")
save.set_legend_action(action_type="melee", charge_cost=1, name="Tail Attack", dice_rolls="2d8+9")
save.set_action_in_arsenal(action_type="melee", name="Bite", dice_rolls="2d10+8")
