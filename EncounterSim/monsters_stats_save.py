...
save.set_action(action_type="melee", name="Frost Brand Rapier", dice_rolls=[(1,8,5)], damage_type="magical")
...
save = MainStats()
save.set_main_stats("Ewyn", ac=21, hp=71, ini_mod=-1, ini_adv=True, attack_mod=6, number_of_attacks=2, is_monster=False)
save.add_avg_dmg(1, 12, 3)
save.set_abilities(3, -1, 4, 0, 0, 2)
save.set_saves(5, 1, 6, 2, 5, 7)
...
save.set_main_stats("Iaachus", ac=16, hp=49, ini_mod=2, attack_mod=5, number_of_attacks=2, is_monster=False, resistances=["nonmagical"])
save.add_avg_dmg(2, 6, 3)
save.set_abilities(3, 2, 4, -1, -1, 1)
save.set_saves(6, 2, 7, -1, -1, 1)
...
save.set_saves(-1, 0, 1, 3, 7, 4)
save.set_action(name="Spellcasting", action_type="spell")
save.set_spell_slots(4, 4, 3, 3, 0, 0, 0, 0, 0)
save.set_spellbook(["Guiding Bolt", ("Toll the Dead", "2d12")])
save.save_main_stats()

save = MainStats()
save.set_main_stats("Reaghan", ac=13, hp=54, ini_mod=2, attack_mod=7, number_of_attacks=1, is_monster=False, dc=15)
save.add_avg_dmg(3, 6, 0)
save.set_abilities(0, 1, 3, 0, -1, 3)
save.set_saves(0, 3, 3, 0, -1, 5)
save.set_action(name="Spellcasting", action_type="spell")
save.set_spell_slots(4, 4, 3, 3, 0, 0, 0, 0, 0)
save.set_spellbook(["Cloud of Daggers", "Dissonant Whispers", ("Vicious Mockery", "2d4")])
save.save_main_stats()
...
save = MainStats()
save.set_main_stats("Ancient Blue Dragon", ac=22, hp=481, dc=20, ini_mod=0, attack_mod=16, number_of_attacks=3, legend_actions_charges=3)
save.add_avg_dmg(2, 6, 6)
save.set_abilities(4, 4, 4, 2, 3, 3)
save.set_saves(4, 9, 9, 2, 3, 8)
...
save.set_action_in_arsenal(action_type="multiattack", multiattack_list=["Bite", "Claws", "Claws"])
save.set_action_in_arsenal(action_type="aoe", has_attack_mod=False, has_dc=True, dc_type="dex", dice_rolls="16d10", aoe_size=(120, 10), aoe_shape="line", damage_type="lightning", has_recharge=True, recharge=5)
save.save_main_stats()
