...
save = MainStats()
save.set_main_stats("Devil Crossbowman", ac=20, hp=60, attack_mod=10, dc=17, immunities=["fire", "poison"], resistances=["acid", "cold", "nonmagical"], number_of_attacks=2, move_behavior="Ranged", creature_type="fiend")
...
save = MainStats()
save.set_main_stats("Devil Knight Captain", ac=20, hp=175, number_of_attacks=2, attack_mod=10, dc=17, immunities=["fire", "poison"], resistances=["acid", "cold", "nonmagical"], creature_type="fiend")
save.set_abilities(5, 0, 3, 3, 2, 4)
save.set_saves(5, 5, 8, 3, 2, 9)
save.set_action(action_type="melee", name="Hellfire Sword", dice_rolls="1d12+2d10+5", damage_type="fire")
save.set_action(action_type="melee", name="Hellfire Sword", dice_rolls="1d12+2d10+5", damage_type="fire")
