...
save = MainStats()
save.set_main_stats("Caldriel", ac=21, hp=420, dc=26, ini_mod=7, attack_mod=16, number_of_attacks=3, regeneration=20, legend_actions_charges=3, legend_resistances=3)
...
save.set_legend_action(action_type="melee", charge_cost=1, name="Flail", dice_rolls="2d8+8d8+8", damage_type="force")
