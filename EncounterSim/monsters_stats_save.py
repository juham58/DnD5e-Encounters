...
save = MainStats()
save.set_main_stats("Le Revenant", ac=21, hp=224, attack_mod=15, number_of_attacks=2)
save.set_abilities(0, 6, 5, 1, 0, 1)
save.set_saves(1, 13, 6, 7, 0, 1)
save.set_action(action_type="melee", name="Dagger", dice_rolls="1d4+1d10+11")
save.set_action(action_type="melee", name="Dagger", dice_rolls="1d4+1d10+11")
save.save_main_stats()

save = MainStats()
save.set_main_stats("Hobgoblin Berseker", ac=20, hp=148, attack_mod=13, number_of_attacks=3, brutal_critical=2, resistances=["nonmagical", "fire", "cold", "bludgeoning", "slashing", "necrotic", "acid", "force", "lightning", "piercing", "poison", "radiant", "thunder", "magical"])
save.set_abilities(6, 2, 4, 0, 0, 2)
save.set_saves(11, 2, 9, 0, 0, 2)
save.set_action(action_type="melee", name="Greataxe +2", dice_rolls="1d12+11")
save.set_action(action_type="melee", name="Greataxe +2", dice_rolls="1d12+11")
save.set_action(action_type="melee", name="Greataxe +2", dice_rolls="1d12+11")
save.save_main_stats()
...
save = MainStats()
save.set_main_stats("Vampire", ac=16, hp=144, dc=18, ini_mod=4, attack_mod=9, number_of_attacks=2, legend_actions_charges=3, resistances=["necrotic", "nonmagical"], legend_resistances=3, regeneration=20)
