...
save = MainStats()
save.set_main_stats("Gwenyth", ac=16, hp=77, dc=14, ini_mod=7, attack_mod=11, number_of_attacks=2, is_monster=False, focus_type="focused", move_behavior="Ranged")
...
save = MainStats()
save.set_main_stats("Kal", ac=16, hp=17, dc=10, ini_mod=2, ini_adv=True, attack_mod=13, number_of_attacks=3, is_monster=False, resistances=["nonmagical", "magical", "acid", "cold", "fire", "force", "lightning", "necrotic", "poison", "radiant", "thunder"]) # totem of the bear+rage
...
save = MainStats()
save.set_main_stats("Kara", ac=18, hp=83, dc=13, ini_mod=4, attack_mod=8, number_of_attacks=3, is_monster=False, max_ki_points=9, evasion=True, resistances=["cold"])
...
save.set_main_stats("Denis", ac=16, hp=96, dc=14, ini_mod=1, attack_mod=11, number_of_attacks=2, is_monster=False, divine_smite=True, focus_type="focused", crits_on=19) # 59 max hp
...
save.set_action(action_type="melee", name="Halberd, +1", dice_rolls="1d10+11", damage_type="magical") # + hexblade's curse (accurate si focused)
save.set_spell_slots(3, 2, 0, 0, 0, 0, 0, 0, 0)
save.save_main_stats()

save = MainStats()
save.set_main_stats("Ghaz", ac=21, hp=21, dc=17, ini_mod=-1, attack_mod=9, number_of_attacks=1, is_monster=False, move_behavior="Support", spellcasting_ability="wis")
save.set_abilities(3, -1, 1, -1, 5, 2)
save.set_saves(3, 2, 1, -1, 5, 5)
save.set_action(name="Spellcasting", action_type="spell")
#save.set_spell_slots(4, 3, 3, 3, 1, 0, 0, 0, 0)
save.set_spell_slots(2, 1, 2, 3, 0, 0, 0, 0, 0)
