...
save = MainStats()
save.set_main_stats("Ewyn", ac=16, hp=13, ini_mod=-1, attack_mod=5, number_of_attacks=1, is_monster=False)
...
save = MainStats()
save.set_main_stats("Gowon", ac=13, hp=11, ini_mod=2, attack_mod=5, number_of_attacks=1, is_monster=False, dc=13)
...
save = MainStats()
save.set_main_stats("Iaachus", ac=15, hp=15, ini_mod=2, attack_mod=5, number_of_attacks=1, is_monster=False)
...
save = MainStats()
save.set_main_stats("Reaghan", ac=12, hp=11, ini_mod=1, attack_mod=5, number_of_attacks=1, is_monster=False, dc=13)
...
save = MainStats()
save.set_main_stats("Vilgefortz", ac=14, hp=8, ini_mod=3, attack_mod=5, number_of_attacks=1, is_monster=False)
...
save = MainStats()
save.set_main_stats("Sartin", ac=13, hp=9, ini_mod=0, attack_mod=5, number_of_attacks=1, is_monster=False)
